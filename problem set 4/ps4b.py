...
WORDLIST_FILENAME = '/Users/griffinmfalme/Dev/Academy/problem set 4/words.txt'
...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        '''
        lowercase_list = [x for x in string.ascii_lowercase]
        shift_lowercase = lowercase_list[shift:] + lowercase_list[:shift]
        lowercase_dict = dict(zip(lowercase_list, shift_lowercase))
        uppercase_list = [x for x in string.ascii_uppercase]
        shift_uppercase = uppercase_list[shift:] + uppercase_list[:shift]
        uppercase_dict = dict(zip(uppercase_list, shift_uppercase))
    ...
    def apply_shift(self, shift):
        ...
        for key in self.message_text:
            ...
            if key in valid_letters:
                cipher_text = self.build_shift_dict(shift).get(key)
            else:
                cipher_text = key
            cipher_map.append(cipher_text)

        return ''.join(cipher_map)
